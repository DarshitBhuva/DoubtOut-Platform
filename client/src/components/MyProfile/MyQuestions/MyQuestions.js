...
export default function MyQuestions() {
    ...
    const fetchAllFilteredQuestions = async () => {
        const response = await fetch(`https://doubtout-backend.onrender.com/api/question/fetchUserFilteredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/question/usedtags/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
