...
export default function UpdateQuestion(props) {
    ...
    const fetchQuestion= async(id)=>{
        const response = await fetch(`https://doubtout-backend.onrender.com/api/question/fetchQueById/${id}`, {
            method: 'POST',
            headers: {
    ...
    const updateQue = async(e, id)=>{
        ...
        const response = await fetch(`https://doubtout-backend.onrender.com/api/question/updateque/${id}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
