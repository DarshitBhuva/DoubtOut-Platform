...
export default function Profile() {
    ...
    const fetchAllFilteredAnswers = async () => {
        const response = await fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserFilteredAnswers/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/givenAnswersTags/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserAnswers/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
