...
export default function Analysis() {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/question/fetchUserQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserAcceptedAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserAnsweredQuestions/${localStorage.getItem("username")}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
