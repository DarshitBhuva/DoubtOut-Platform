...
export default function QuestionOnTags() {
    ...
    const fetchQue = async (tagname) => {
        await fetch(`https://doubtout-backend.onrender.com/api/question/fetchQuePertag/${tagname}`, {
            method: "POST",
            headers: {
    ...
    const tagDesc = async (tagname) => {
        await fetch(`https://doubtout-backend.onrender.com/api/tag/tagdesc/${tagname}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
