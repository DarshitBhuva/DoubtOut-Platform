...
export default function Adminanswer() {
    ...
    const fetchAllFilteredAnswers = async () => {
        const response = await fetch(`https://doubtout-backend.onrender.com/api/answer/fetchAllFilteredAnswers`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/givenAllAnswersTags/`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUseranswer`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
