...
export default function AdminAnalysis() {
 ...
 const[NoOfQuestions,setNoofquestion]=useState([])
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/question/fetchquestions`, {
            method: "POST",
            headers: {
    ...
    const noOfQuestions = async () => {
        await fetch('https://doubtout-backend.onrender.com/api/admin/noOfQuestions', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const noOfusers =  async () => {
        await fetch('https://doubtout-backend.onrender.com/api/admin/noOfUsers', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const noOfAnswers = async () => {
        await fetch('https://doubtout-backend.onrender.com/api/admin/noOfAnswers', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const noOfAccept = async () => {
        await fetch('https://doubtout-backend.onrender.com/api/admin/noOfAccept', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const fetchQuestions = async () => {
        await fetch('https://doubtout-backend.onrender.com/api/admin/questions', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch('https://doubtout-backend.onrender.com/api/admin/question-by-month');
  ...
  useEffect(() => {
    async function fetchData() {
        try {
            const response = await fetch('https://doubtout-backend.onrender.com/api/admin/question-by-year');
            const data = await response.json();
            data.forEach(item => {
