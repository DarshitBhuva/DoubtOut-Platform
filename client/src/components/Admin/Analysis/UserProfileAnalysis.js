...
export default function UserProfileAnalysis() {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/question/fetchUserQuestions/${username}`, {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserAcceptedAnsweredQuestions/${username}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    useEffect(() => {
        fetch(`https://doubtout-backend.onrender.com/api/answer/fetchUserAnsweredQuestions/${username}`, {
            method: "POST",
            headers: {
                'Content-Type': 'application/json'
            }
